...
public enum RoundingMode {
	 ...
	 * a non-zero discarded fraction. Note that this rounding mode never decreases
	 ...
	 * for {@code RoundingMode.DOWN}. Note that this rounding mode never decreases
	 ...
	 * {@code RoundingMode.HALF_DOWN} if it's even. Note that this is the rounding
	 * mode that statistically minimizes cumulative error when applied repeatedly
	 * over a sequence of calculations. It is sometimes known as
