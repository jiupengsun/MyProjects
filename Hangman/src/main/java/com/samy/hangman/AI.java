...
* 1. SCOWL http://wordlist.aspell.net/, an English word dataset more than 8MB
* 2. A blog gave a basic strategy for hangman
* http://www.datagenetics.com/blog/april12012/. This page gave a form which I used in
* my program.
*
...
* thread will rank as following procedure:
...
* would never choose this letter;
...
* font letter be eliminated, the latter letter would have higher probability;
...
*
* Import this project into Intellij, or
*
*
* */
