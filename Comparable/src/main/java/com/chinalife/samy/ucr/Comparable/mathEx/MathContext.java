...
public final class MathContext implements Serializable {
	 ...
	 * the string is out of range ({@code < 0}) or the string is not in the format
	 * created by the {@link #toString} method.
	 *
	 * @param val
	 ...
	 * {@code String} returned represents the settings of the {@code MathContext}
	 * object as two space-delimited words (separated by a single space character,
	 * <tt>'&#92;u0020'</tt>, and with no leading or trailing white space), as
	 * follows:
	 * <ol>
