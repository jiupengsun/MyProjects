...
class BitSieve {
	 ...
	 * BitSieve(BigInteger base, int searchLen). The length of the sieve generated
	 * by this constructor was chosen for performance; it controls a tradeoff
	 * between how much time is spent constructing other sieves, and how much time
	 * is wasted testing composite candidates for primality. The length was chosen
	 * experimentally to yield good performance.
	 */
	private BitSieve() {
		length = 150 * 64;
	 ...
	 * candidates. The new sieve begins at the specified base, which must be even.
	 */
	BitSieve(BigInteger base, int searchLen) {
		/*
		 * Candidates are indicated by clear bits in the sieve. As a candidates
		 * nonprimality is calculated, a bit is set in the sieve to eliminate it. To
		 * reduce storage space and increase efficiency, no even numbers are
		 * represented in the sieve (each bit in the sieve represents an odd
		 * number).
		 */
	 ...
	 * that occurs at or after start. It will not search past the specified limit.
	 * It returns -1 if there is no such clear bit.
	 */
	...
	/**
	 * Sieve a single set of multiples out of the sieve. Begin to remove multiples
	 * of the specified step starting at the specified start index, up to the
	 * specified limit.
	 */
